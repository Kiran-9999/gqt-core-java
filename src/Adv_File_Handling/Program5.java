...
public class Program5 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		File f=new File("C:\\Users\\kiran\\Documents\\GQT Core-Java\\IOprogs\\Sample1.txt");
...
//		System.out.println(b2);
		...
		f.deleteOnExit();
		// Deletes the file after the execution and when the Virtuval machine is terminated
		System.out.println("---------");
//		for(int i=1;i<5;i++) {
